    ...
    <section id="services" className="py-20 container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          >
            Edit the details of any step...
          </motion.h2>
          <motion.p
            variants={fadeIn('up', 0.5)}
            className="text-gray-600 text-lg mb-4 md:w-4/5"
          >
            Before generating a plan issue specification is there can be right inside.
          </motion.p>
          <motion.div
          ...
          >
            ...
            >
              ...
              <span className="text-gray-600">A workflow that's are collabrate by defaults</span>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <span className="text-gray-600">Open Work designers who will take your vision</span>
            </motion.div>
          </motion.div>
          <motion.button
